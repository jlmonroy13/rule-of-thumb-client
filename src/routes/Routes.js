...
import { HOME, PAST_TRIALS, HOW_IT_WORKS, LOGIN, TERMS_AND_CONDITIONS, PRIVACY_POLICY, CONTACT_US } from 'constants/pathNames';
...
const Routes = () => <Switch>{publicRoutes.map(renderRoutes)}</Switch>;
